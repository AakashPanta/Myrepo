...
def write_common_files(base, project_name):
    (base / "assets").mkdir()
    (base / "examples").mkdir()
    (base / "docs").mkdir()
...
def bootstrap_python_cli(base, project_name):
    (base / "src").mkdir()
    (base / "tests").mkdir()
...
def bootstrap_docs(base, project_name):
...
def bootstrap_automation_tool(base, project_name):
    (base / "src").mkdir()
    (base / "tests").mkdir()
    (base / "data").mkdir()
    (base / "logs").mkdir()
...
def bootstrap(project_name, template_name):
    templates = {"python-cli", "docs", "automation-tool"}

    if template_name not in templates:
        print(f"Unknown template: {template_name}")
        print("Available templates: python-cli, docs, automation-tool")
        return
